...
def main():
    root_dir = "F:/Final_project/DAQ Dev2/Software/dataset_preprocessed"
    ...
    print(entropies.sort_values(ascending=False).head(5))

    # Calculate mutual information
    mi_scores = calculate_mutual_info(X, y)
    print("Top 5 features by mutual information:")
    print(mi_scores.sort_values(ascending=False).head(5))
